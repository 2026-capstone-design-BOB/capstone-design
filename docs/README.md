...
| **도구** | **40개** (**승인 필수 3개** — 삭제 2 + `click_ui_element` · `describe_screen`·`find_ui_element`·`watch_screen`은 화면을 외부 LLM에 전송) |
