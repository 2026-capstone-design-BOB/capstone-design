...
| **테스트** | mock **25파일 517개** + 라이브 3스위트. CI는 그중 24파일 485개 자동 실행 (`test_dependencies` 32개는 로컬 전용) — **이 숫자의 출처는 이 표 하나다** |
...
| 하려는 작업 | 읽을 문서 |
|---|---|
| **새 도구 추가** | [ARCHITECTURE.md § 도구](ARCHITECTURE.md#도구-35개) → [WORKFLOW.md § 도구 추가 절차](WORKFLOW.md#새-도구-추가) |
