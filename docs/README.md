...
| **도구** | **36개** (삭제 2개는 HITL 승인 필수 · `describe_screen`·`find_ui_element`는 화면을 외부 LLM에 전송) |
...
| **테스트** | mock **26파일 558개** + 라이브 3스위트. CI는 그중 25파일 526개 자동 실행 (`test_dependencies` 32개는 로컬 전용) — **이 숫자의 출처는 이 표 하나다** |
